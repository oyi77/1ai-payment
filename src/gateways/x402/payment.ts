...
import type { X402PaymentRequirement, X402AcceptedPayment } from './types';
import { X402_VERSION, X402_DEFAULT_TIMEOUT, DEFAULT_USDC_ADDRESSES } from './types';
 ...
 */
export async function buildPaymentRequirement(params: CreatePaymentParams): Promise<CreatePaymentResult> {
